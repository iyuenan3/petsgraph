...
`.NET 10` 的 38 项核心测试、WPF 交叉编译、公开合成包以及五百和飞流真实候选的原生校验已经通过。测试覆盖首装与更新回滚、进程中断恢复、事务卸载、损坏设置、长时间帧索引和真实媒体摘要。真实 Windows 11 x64 上的透明命中、DPI、拖动、托盘、多显示器、隐藏恢复、升级保留和长时间视觉验收仍是正式发布前的人类闸门。
