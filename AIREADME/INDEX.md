...
> last-synced: 8173443 · 2026-08-17
> phase: public-low-power-v0.4.0 + feiliu-runtime-integration
...
| SPEC | ✅ | PNG 事实源、固定裁剪 RGBA、飞流 11 节点 20 边动作图和场景坐姿契约 |
| ARCHITECTURE | ✅ | 数据驱动 App、加权随机图、飞流双枢纽与半仰路线、CALayer、raw mmap 与单实例 |
| DEPLOYMENT | ✅ | Apple 芯片 `0.4.0` 本机构建、Release 校验、性能测量与非公证边界 |
| PRD | ✅ | 安静睡眠陪伴、图上随机换姿、飞流 9 睡姿猫窝图、朋友安装和人工定制边界 |
| ROADMAP | ✅ | 飞流素材图已通过，下一步是素材包编译、随机运行时与真实桌面验收 |
| CONVENTIONS | ✅ | 场景坐姿、随机权重、静态与视频 provider 分工、固定 raw crop 和验收约定 |
| DECISIONS | ✅ | 追加人工定制方向、飞流猫窝替代毛毯、当前 11 节点动作图和 gpt-image-2 边界 |
