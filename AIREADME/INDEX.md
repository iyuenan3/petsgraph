...
| DEPLOYMENT | ✅ | macOS build 5 动作链、build 8 完整切换、build 10 卸载、build 11 双宠重装、build 12 菜单灰显、build 13 Dock、build 14 位置持久化与边缘大小重启人工通过及 v0.6.0 历史基线 |
...
| CHANGELOG | ✅ | 记录 2026-08-23 目录迁移、PetPack 1.0、双宠候选、双平台 Player、缓存贴边、build 10 至 14 装卸、菜单、Dock 拖动、四边、七档大小、重启人工通过、位置持久化、资源和完整复验证据 |
