...
| DEPLOYMENT | ✅ | macOS build 5 动作链、build 8 完整切换、build 10 卸载、build 11 双宠重装、build 12 菜单灰显、build 13 Dock 与资源证据及 v0.6.0 历史基线 |
...
| CHANGELOG | ✅ | 记录 2026-08-23 目录迁移、PetPack 1.0、双宠候选、双平台 Player、缓存贴边、build 10 至 13 装卸、菜单、Dock 拖动人工通过、资源和完整复验证据 |
