...
| DEPLOYMENT | ✅ | macOS build 5 动作链、build 8 完整切换、build 9 资源证据、build 10 卸载、build 11 双宠重装、build 12 菜单灰显、build 13 Dock 层级及 v0.6.0 历史基线 |
...
| CHANGELOG | ✅ | 记录 2026-08-23 目录迁移、PetPack 1.0、双宠候选、双平台 Player、缓存贴边、build 9 资源与 build 10 至 13 装卸、菜单和 Dock 证据 |
