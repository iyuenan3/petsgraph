...
> last-synced: 9250db4 · 2026-08-10
...
| ARCHITECTURE | ✅ | 睡眠动作图、指定睡姿队列、行为规划、透明窗口与公开发布数据流 |
| DEPLOYMENT | ✅ | Apple 芯片 `0.3.0` DMG、Release 附件、构建校验、发布与非公证边界 |
| PRD | ✅ | 安静睡眠陪伴、朋友安装、指定睡姿、枕头核心场景和 PM 风险闸门 |
| ROADMAP | ✅ | 首个公开 alpha 已就绪，下一阶段验证真实安装、长期陪伴和通用素材 Skill |
| CONVENTIONS | ✅ | 中文 UI、睡眠场景、素材版本、随机调度、Release 附件与验收约定 |
| DECISIONS | ✅ | 追加指定睡姿、公开素材分发、Apple 芯片首发和受验证发布策略 |
| MEMORY | ✅ | 素材、运行时与 macOS 打包事故，以及从能力展示转向安静陪伴的复盘 |
| CHANGELOG | ✅ | `0.3.0` 公开版、中文指定睡姿、发布附件和既有素材里程碑 |
